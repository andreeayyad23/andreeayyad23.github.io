...
- 🎓 I am a <code>Full Stack Developer</code> specializing in Web Development at <a href="https://www.codingdojo.com" target="_blank">Coding Dojo</a>.
- 💻 I love creating software solutions to solve real-world problems.
- 🌟 I am passionate about competitive programming and actively engage on platforms like <code>LeetCode</code> and <code>HackerRank</code>.
- 📘 Currently learning: Advanced <code>Computer Science</code> concepts, <code>Back-End</code>, <code>Front-End</code>, and <code>Software Engineering</code>.
- 🤓 Always exploring and learning new technologies to expand my skill set.
- 🚀 Open to exciting job opportunities in Back-End, Front-End, or Full-Stack development. Check out <a href="https://drive.google.com/file/d/1n7DcF8tUM55K01v2l7noOvPywzMbAzFV/view?usp=sharing" target="_blank">MY RESUME</a>!
